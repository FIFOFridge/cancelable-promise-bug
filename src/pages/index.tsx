...
const IndexPage = () => {
    ...
    useEffect(() => {
        const externalAsyncTask: CancelablePromise<any> = cancelable(performUtilAsyncTask())
        const componentAynscTask: CancelablePromise<any> = cancelable(performComponentAynscTask())
